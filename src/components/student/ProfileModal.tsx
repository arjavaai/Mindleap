...
import { User, Trophy, Flame, Mail, Phone, School, MapPin, Calendar, Users, LogOut } from 'lucide-react';
...
const ProfileModal: React.FC<ProfileModalProps> = ({ studentData, loading = false }) => {
      ...
      <DialogContent className="sm:max-w-[500px] max-h-[80vh] overflow-y-auto">
        ...
        {loading ? (
          ...
          <div className="space-y-6 py-4">
            ...
            {/* Logout Button - Moved before Parent Information for better visibility */}
            <div className="pt-4 border-t">
              <Button
                onClick={handleLogout}
                variant="outline"
                className="w-full flex items-center justify-center gap-2 text-red-600 hover:text-red-700 hover:bg-red-50 border-red-200 hover:border-red-300 py-3"
              >
