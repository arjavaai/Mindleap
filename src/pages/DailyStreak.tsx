  ...
  const getTodaySubject = async (): Promise<Subject | null> => {
    ...
    try {
      const subjectsQuery = query(
        ...
        where('scheduledDay', '==', todayDayName)
      );
  ...
  const getRandomQuestionForToday = async (subjectId: string, answeredQuestionIds: string[]) => {
    try {
      ...
      if (!questionsSnapshot.empty) {
        ...
        const availableQuestions = questionsSnapshot.docs.filter(
      ...
      >
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <motion.div
            ...
            className="bg-white/70 backdrop-blur-sm rounded-3xl shadow-xl border border-white/50 overflow-hidden"
          >
                ...
                {todayRecord && (
                  <motion.div
                    ...
                    className={`w-12 h-12 rounded-full flex items-center justify-center ${
                      todayRecord.isCorrect ? 'bg-green-500' : 'bg-red-500'
                    }`}
                  >
              ...
              {todayRecord ? (
                ...
                >
                  ...
                  <h4 className={`text-2xl font-bold mb-2 ${
                    todayRecord.isCorrect ? 'text-green-600' : 'text-red-600'
                  }`}>
                  ...
                  {todayRecord.explanation && (
                    <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-4 rounded-xl text-left">
                ...
                >
                  ...
                  <motion.button
                    ...
                    className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-bold py-4 px-8 rounded-xl shadow-lg transform transition-all duration-200"
                    whileHover={{ 
                      scale: 1.05,
